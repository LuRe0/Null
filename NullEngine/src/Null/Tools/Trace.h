...
// In Release or Dist, disable all logs except errors and throws

#define NLE_CORE_TRACE(...)     (void)0
#define NLE_CORE_INFO(...)      (void)0
#define NLE_CORE_WARN(...)      (void)0
#define NLE_CORE_DEBUG(...)     (void)0
#define NLE_CORE_ERROR(...)     ::NULLENGINE::Trace::GetCoreLogger()->error(__VA_ARGS__)
//#define NLE_CORE_FATAL(...)    (void)0
...
#define NLE_TRACE(...)          (void)0
#define NLE_INFO(...)           (void)0
#define NLE_WARN(...)           (void)0
#define NLE_ERROR(...)          ::NULLENGINE::Trace::GetClientLogger()->error(__VA_ARGS__)
#define NLE_DEBUG(...)          (void)0
