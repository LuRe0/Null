...
//------------------------------------------------------------------------------
//
// File Name:	TriangleInstanceMesh.h
// Author(s):	name
// 
//------------------------------------------------------------------------------
...
namespace NULLENGINE
{
	...
	class NLE_API TriangleInstanceMesh : public Mesh
	{
	public:


		TriangleInstanceMesh(const std::string& filename, const uint32_t vertexCount, const uint32_t indexCount);
		TriangleInstanceMesh() = default;
		~TriangleInstanceMesh();
