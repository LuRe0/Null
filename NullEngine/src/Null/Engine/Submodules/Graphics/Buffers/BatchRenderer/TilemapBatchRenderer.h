...
namespace NULLENGINE
{
	...
	class TilemapBatchRenderer : public BatchRenderer
	{
	public:
		TilemapBatchRenderer(std::size_t count)
		{
	...
	template <typename TInstance, typename TMesh>
	inline void TilemapBatchRenderer<TInstance, TMesh>::BeginBatch()
	{
	...
	template <typename TInstance, typename TMesh>
	inline void TilemapBatchRenderer<TInstance, TMesh>::ImguiView()
	{
		if (!m_Stats.DrawCalls) return;

		ImGui::Text("Render Type: %s", "TILEMAP");
	...
	template <typename TInstance, typename TMesh>
	inline void TilemapBatchRenderer<TInstance, TMesh>::ResetStats()
	{
		m_Stats.DrawCalls = 0;
