...
namespace NULLENGINE
{
	...
	{
	public:
		LineBatchRenderer(std::size_t count)
		{
	...
	template <typename TInstance, typename TMesh>
	inline void LineBatchRenderer<TInstance, TMesh>::BeginBatch()
	{
	...
	template <typename TInstance, typename TMesh>
	inline void LineBatchRenderer<TInstance, TMesh>::ImguiView()
	{
	...
	template <typename TInstance, typename TMesh>
	inline void LineBatchRenderer<TInstance, TMesh>::ResetStats()
	{
		m_Stats.DrawCalls = 0;
