...
namespace NULLENGINE
{
	...
	public:
		QuadBatchRenderer()
		{
			...
			m_InstanceMesh = std::make_unique<TMesh>("Quad", m_MaxVertices, m_MaxIndices);
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::BeginBatch()
	{
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::NextBatch()
	{
		Flush();
		BeginBatch();
	}
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::Flush()
	{
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::AddInstance(const ElementData& render)
	{
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::ImguiView()
	{
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::ResetStats()
	{
		m_Stats.DrawCalls = 0;
	...
	template<typename TInstance, typename TMesh, std::size_t TCount>
	inline void QuadBatchRenderer<TInstance, TMesh, TCount>::BindTextureBuffer()
	{
