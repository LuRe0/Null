...
#define GL(function) \
	...
	{
		std::string vertexPath = std::string("Data/Shaders/Scripts/") + std::string(name) + "V" + std::string(".glsl");
		std::string fragmentPath = std::string("Data/Shaders/Scripts/") + std::string(name) + "F" + std::string(".glsl");
