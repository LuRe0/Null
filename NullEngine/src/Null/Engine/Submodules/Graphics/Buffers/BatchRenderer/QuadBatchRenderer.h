...
namespace NULLENGINE
{
	...
	{
	public:
		QuadBatchRenderer(std::size_t count)
		{
	...
	template <typename TInstance, typename TMesh>
	inline void QuadBatchRenderer<TInstance, TMesh>::BeginBatch()
	{
	...
	template <typename TInstance, typename TMesh>
	inline void QuadBatchRenderer<TInstance, TMesh>::ImguiView()
	{
	...
	template <typename TInstance, typename TMesh>
	inline void QuadBatchRenderer<TInstance, TMesh>::ResetStats()
	{
		m_Stats.DrawCalls = 0;
