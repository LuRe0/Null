...
//------------------------------------------------------------------------------
//
// File Name:	CircleInstanceMesh.h
// Author(s):	name
// 
//------------------------------------------------------------------------------
...
namespace NULLENGINE
{
	...
	class NLE_API CircleInstanceMesh : public Mesh
	{
	public:


		CircleInstanceMesh(const std::string& filename, const uint32_t vertexCount, const uint32_t indexCount);
		CircleInstanceMesh() = default;
		~CircleInstanceMesh();
