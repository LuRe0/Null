...
namespace NULLENGINE
{
	...
	class NLE_API QuadInstanceMesh : public Mesh
	{
	public:


		QuadInstanceMesh(const std::string& filename, const uint32_t vertexCount, const uint32_t indexCount);
		QuadInstanceMesh() = default;
		~QuadInstanceMesh();
